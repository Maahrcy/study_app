...
class BD {
  ...
  static List<Resumo> listaResumes = [
    Resumo(titulo: 'Isomeria', text: '  Isomeria química é um fenômeno observado quando duas ou mais substâncias orgânicas têm a mesma fórmula molecular, mas estrutura molecular e propriedades diferentes. \n '
